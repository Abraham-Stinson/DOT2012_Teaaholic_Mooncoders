...
public class NPCGroup : MonoBehaviour
{
    ...
    [SerializeField] private float patienceBonusPerDrink = 20f; // Patience bonus when a drink is served
    [SerializeField] private float patienceBonusPerGame = 25f; // Patience bonus when a game is served
